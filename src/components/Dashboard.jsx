...
const Dashborad = () => {
  ...
  const renderLinks = (links) =>
    links.map((link, index) => (
      <Link
        key={index}
        to={link.to}
        className="flex items-center gap-x-3 py-2.5 px-4 text-gray-200 rounded-lg hover:bg-gray-700 hover:text-white transition duration-200 group"
        onClick={link.click}
      >
  ...
  return (
    <nav className="bg-gradient-to-b from-gray-800 to-gray-900 w-full lg:w-64 flex flex-col p-4 lg:h-full shadow-xl border-r border-gray-700">
      <div className="flex justify-between items-center mb-4 lg:mb-10">
        <Link to="/" className="flex justify-center items-center">
          <img
            src={logoMuni}
            className="h-12 lg:h-20 object-contain drop-shadow-md "
            alt="Logo"
          />
        </Link>
        <button
          className="lg:hidden text-white hover:bg-gray-700 p-2 rounded-lg transition"
        ...
        <div className={`lg:flex flex-col ${menuOpen ? "block" : "hidden"}`}>
          {user.role === "superadmin" && (
            <>
              ...
              <div className="mt-2 ml-2 bg-gray-800 rounded-xl shadow-lg border border-gray-700 overflow-hidden">
                <button
                  className="flex justify-between items-center text-gray-200 py-3 px-4 w-full rounded-lg hover:bg-gray-700 transition font-medium tracking-wide"
                ...
                >
                  ...
                  <svg
                    ...
                    className={` transition-transform duration-300 ease-in-out ${dropdownOpen ? "rotate-180 text-blue-400" : ""}`}
              ...
              <div className="mt-2 ml-2 bg-gray-800 rounded-xl shadow-lg border border-gray-700 overflow-hidden">
                ...
                >
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={`transition-transform duration-300 ease-in-out ${dropdownOpenTareas ? "rotate-180 text-blue-400" : ""}`}
                  >
                    <path d="M6 9l6 6 6-6" />
                  </svg>
                </button>
              ...
              <div className="mt-2 ml-2 bg-gray-800 rounded-xl shadow-lg border border-gray-700 overflow-hidden">
                ...
                >
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={`transition-transform duration-200 ${dropdownOpenPc ? "rotate-180" : "rotate-0"
                      }`}
                  >
                    <path d="M6 9l6 6 6-6" />
                  </svg>
