...
import ModalAddUni from "../components/ModalAddUni";
...
const Toners = () => {
  ...
  const handleUniAdded = (newUni) => {
    setUni((prevUni) => [...prevUni, newUni])
      ...
      {(user.role === 'admin' || user.role === 'superadmin') && (
        <>
          ...
          <div className="flex item-center">
            <div className="text-center mt-3 p-4">
              ...
              {showTonersTable ? (
                ...
                <button
                  onClick={openModalUni}
                  className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                >
                  Agregar Unidad de Imagen
                </button>
          ...
          <Modal
            ...
            overlayClassName="overlay"
          >
            <ButtonClose onClick={closeModalUni} />
            <ModalAddUni onUniAdded={handleUniAdded} onClose={closeModalUni} />
          </Modal>
